...
const footerLinks = {
  ...
  Company: ["A Propos de Nous", "Carrières", "Partenaires", "Blog"],
  Support: [
    "Centre d'aide",
    "Contactez nous",
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
              Redéfinir votre façon d'explorer le monde. Séjours de qualité,
              expériences uniques et souvenirs inoubliables.
            </p>
            <div className="mt-4 flex items-center gap-3">
              <a
                href="#"
                className="flex h-8 w-8 items-center justify-center rounded-full bg-muted text-muted-foreground transition-colors hover:bg-[#2563eb] hover:text-white"
                aria-label="Facebook"
              >
                <svg
                  className="h-4 w-4"
      ...
      <div className="border-t border-border">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 py-6 sm:flex-row lg:px-8">
          <p className="text-xs text-muted-foreground">
            &copy; 2025 Tourisia . Tous droits réservés.
          </p>
